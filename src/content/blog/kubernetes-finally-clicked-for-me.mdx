...
image: '/writing/kubernetes-finally-clicked-for-me/hero.webp'
imageBlurhash: ''
...
you push code. five minutes later its in prod. nobody ran a single manual command. thats the version of kubernetes that makes sense to me.
