...
![Kafka architecture: Client → API → Kafka MSK → Worker → Email/SMS/Voicemail](/writing/stop-reaching-for-kafka/stop-reaching-for-kafka-diagram-1.svg)
...
![BullMQ architecture: Client → API → campaignQueue → campaignStepQueue → emailQueue / smsQueue / voicemailQueue](/writing/stop-reaching-for-kafka/stop-reaching-for-kafka-diagram-2.svg)
