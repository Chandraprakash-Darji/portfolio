...
image: '/writing/small-thank-you-open-source-tools/01-small-tools-daily-setup.png'
imageBlurhash: ''
...
![ghq gathering scattered repositories into one predictable place](/writing/small-thank-you-open-source-tools/02-ghq-one-place.png)
...
![Sponsorships, bug reports, and patches keeping a small project moving](/writing/small-thank-you-open-source-tools/03-keep-it-moving.png)
